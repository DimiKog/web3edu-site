...
export const LM08_ASSESSMENT_COPY = {
  en: {
    ...
    metaScopeHint:
      "Checks deployment lifecycle, contract interaction, inspection, and source verification on Besu Edu-Net.",
    ...
    passCapabilities: [
      "Describe the smart-contract deployment lifecycle.",
      "Distinguish reading state from changing state.",
      "State what source verification does and does not prove.",
    ],
    keyPrinciple:
      "Source verification relates published source to deployed code — it is not a security or trust certificate.",
  ...
  gr: {
    ...
    metaScopeHint:
      "Ελέγχει κύκλο ζωής ανάπτυξης, αλληλεπίδραση συμβολαίου, επιθεώρηση και επαλήθευση πηγαίου κώδικα στο Besu Edu-Net.",
    ...
    passCapabilities: [
      "Περιγράφεις τον κύκλο ζωής ανάπτυξης smart contracts.",
      "Διαχωρίζεις ανάγνωση κατάστασης από αλλαγή κατάστασης.",
      "Λες τι αποδεικνύει και τι δεν αποδεικνύει η επαλήθευση πηγαίου κώδικα.",
    ],
    keyPrinciple:
      "Η επαλήθευση πηγαίου κώδικα συσχετίζει δημοσιευμένο κώδικα με τον ανεπτυγμένο — δεν είναι πιστοποίηση ασφάλειας ή εμπιστοσύνης.",
