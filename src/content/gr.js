...
Με evidence-backed αρχεία προόδου και δομημένες διαδρομές συνεισφοράς, η μάθηση δεν σταματά με την ολοκλήρωση. Εξελίσσεται μέσα από συνεργασία, εφαρμοσμένο πειραματισμό και participation research.`,
    ...
    // -------------------------
    dao: {
        title: "Μελλοντική Συμμετοχή & Έρευνα Διακυβέρνησης",
        desc: "Το Web3Edu εξερευνά πώς εκπαιδευόμενοι, εκπαιδευτικοί και ερευνητές μπορούν να συμμετέχουν σε αποφάσεις γύρω από learning paths, pilots και κανόνες πλατφόρμας αφού πρώτα έχει καταγραφεί evidence-backed δραστηριότητα.",
        imageCaption: "Ένα ερευνητικό πεδίο για participation models, governance experiments και community feedback loops.",
        buttons: {
