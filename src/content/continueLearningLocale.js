...
export const CONTINUE_LEARNING_LOCALE = {
    en: {
        ...
        moduleTitles: {
            ...
            LM06: "Consensus & Block Inclusion",
        ...
        evidenceLabels: {
            ...
            "lm02-decision": "FoodTrace Design Decision (via LM02 Assessment Part B)",
            "lm05-pel-transaction": "Educational Ledger Contribution",
            "lm06-consensus-activity": "Educational Ledger Consensus Activity",
    ...
    gr: {
        ...
        moduleTitles: {
            ...
            LM06: "Συναίνεση & Συμπερίληψη σε Block",
        ...
        evidenceLabels: {
            ...
            "lm02-decision": "Απόφαση Σχεδιασμού FoodTrace (Μέρος Β Αξιολόγησης LM02)",
            "lm05-pel-transaction": "Συνεισφορά στο Εκπαιδευτικό Ledger",
            "lm06-consensus-activity": "Δραστηριότητα Consensus στο Εκπαιδευτικό Ledger",
