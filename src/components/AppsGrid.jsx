...
const AppsGrid = ({ content, badgeLabel = "Ecosystem Overview" }) => (
    <section className="mt-16">
        <div className="absolute left-0 top-0 h-full w-[3px] bg-gradient-to-b from-[#8A57FF] via-[#4ACBFF] to-[#FF67D2] opacity-70 blur-[2px] pointer-events-none" />
        ...
        <div className="px-4 mb-10 text-left animate-[slideFade_0.6s_ease-out]">
            ...
            <div className="relative w-fit">
                <div className="absolute inset-0 overflow-hidden rounded-md pointer-events-none">
                    <div className="absolute top-0 left-0 h-full w-[120%] bg-gradient-to-r from-transparent via-white/40 to-transparent animate-[shine_2s_ease-in-out_infinite]" />
                </div>
                <h2 className="text-4xl font-extrabold tracking-tight text-slate-800 dark:text-white drop-shadow-[0_0_20px_rgba(138,87,255,0.35)]">
                    {content.heading || "Web3Edu Ecosystem"}
                </h2>
            </div>
        </div>
        ...
        {/*
      AppsGrid is categorical, not action-driven.
      Each card represents a capability area of the Web3Edu ecosystem,
      NOT a task, progress state, or completion checkpoint.
      Progress, XP, and completion belong in Labs and Dashboard.
    */}
        <div
            ...
            {["poe", "education", "nft", "dao", "zkp"].map((key) => {
                ...
                const cardContent = (
                    <>
                        ...
                        <div
                            className={`rounded-3xl p-6 sm:p-7 md:p-8 h-full backdrop-blur-xl border border-white/10
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="relative mb-6 h-20 w-20 animate-[float_4s_ease-in-out_infinite]">
                                    <div
                                        className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${theme.ring}
                                ...
                                animate-[pulse_3s_ease-in-out_infinite]`}
                                    ...
                                    <div className="relative flex items-center justify-center h-full w-full">
                                        <Icon
                                            className={`h-10 w-10 ${theme.icon}
                                ...
                                {/* Title */}
                                <h3 className="text-lg sm:text-xl font-bold text-slate-800 dark:text-white mb-3 tracking-tight group-hover:text-[#CBB2FF] transition">
                                    {app.title}
                                </h3>
