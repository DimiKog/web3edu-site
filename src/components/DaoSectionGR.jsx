...
const DEFAULT_CAPTION = "Ένα ερευνητικό πεδίο για participation models, governance experiments και community feedback loops.";

const DEFAULT_STATUS = "preview"; // "preview" | "coming-soon" | "active"

const DaoSectionGR = ({
    content,
    badgeLabel = "Κοινοτική Διακυβέρνηση",
                ...
                <div className="text-left text-white">
                    ...
                    {status !== "active" && (
                        <div className="mt-2 inline-flex items-center rounded-full border border-yellow-400/40 bg-yellow-500/10 px-3 py-1 text-xs font-semibold text-yellow-300">
                            {status === "preview" ? "Ερευνητικό Πεδίο" : "Έρχεται Σύντομα"}
                        </div>
                    )}
                    ...
                    <div className="mt-6 flex flex-wrap gap-4">
                        <Link
                            to={status === "active" ? "/dao-gr" : previewPath}
