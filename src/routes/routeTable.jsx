...
const Lm08AssessmentPage = lazy(
  () => import("../pages/learning-modules/Lm08AssessmentPage.jsx")
);
const Lm02AssessmentPage = lazy(
  () => import("../pages/learning-modules/Lm02AssessmentPage.jsx")
);
const Lm03AssessmentPage = lazy(
  () => import("../pages/learning-modules/Lm03AssessmentPage.jsx")
);
const Lm04AssessmentPage = lazy(
  () => import("../pages/learning-modules/Lm04AssessmentPage.jsx")
);
...
export const routeTable = {
  ...
  web3: {
    ...
    routes: [
      ...
      { path: "/learning-modules/lm08/source-verification", component: Lm08SourceVerificationPage },
      {
      ...
      { path: "/learning-modules/lm08/assessment", component: Lm08AssessmentPage },
      {
        path: "/learning-modules-gr/lm08/assessment",
        component: Lm08AssessmentPage,
        props: { lang: "gr" },
      },
      { path: "/learn", component: LearnPage },
      { path: "/learn-gr", component: LearnPage, props: { lang: "gr" } },
      ...
      { path: "/learning-modules/lm02", component: Lm02Page },
      {
        path: "/learning-modules-gr/lm02",
        component: Lm02Page,
        props: { lang: "gr" },
      },
      { path: "/learning-modules/lm02/assessment", component: Lm02AssessmentPage },
      {
        path: "/learning-modules-gr/lm02/assessment",
        component: Lm02AssessmentPage,
        props: { lang: "gr" },
      },
      { path: "/learning-modules/lm03", component: Lm03Page },
      {
        path: "/learning-modules-gr/lm03",
        component: Lm03Page,
        props: { lang: "gr" },
      },
      { path: "/learning-modules/lm03/assessment", component: Lm03AssessmentPage },
      {
        path: "/learning-modules-gr/lm03/assessment",
        component: Lm03AssessmentPage,
        props: { lang: "gr" },
      },
      { path: "/learning-modules/lm04", component: Lm04Page },
      {
        path: "/learning-modules-gr/lm04",
        component: Lm04Page,
        props: { lang: "gr" },
      },
      { path: "/learning-modules/lm04/assessment", component: Lm04AssessmentPage },
      {
        path: "/learning-modules-gr/lm04/assessment",
        component: Lm04AssessmentPage,
        props: { lang: "gr" },
      },
      { path: "/learning-modules/lm05", component: Lm05Page },
      {
        path: "/learning-modules-gr/lm05",
        component: Lm05Page,
        props: { lang: "gr" },
      },
      { path: "/learning-modules/lm05/assessment", component: Lm05AssessmentPage },
      {
