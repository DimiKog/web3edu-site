...
import Lm05ConceptPanel from "../../components/learning-modules/Lm05ConceptPanel.jsx";
...
/**
 * LM05 Interactive Chapter — Transactions and Blockchain State.
 * @param {{ lang?: "en"|"gr" }} props
 */
export default function Lm05Page({ lang = "en" }) {
  const locale = lang === "gr" ? "gr" : "en";
  const copy = getLmPageCopy(locale, "LM05");
    ...
    <PageShell>
      <div className="mx-auto max-w-7xl px-4 pt-24 pb-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
        <nav className="mb-5 text-sm text-slate-500 dark:text-slate-400">
          ...
          <span className="mx-2">›</span>
          <span className="text-slate-700 dark:text-slate-200">LM05</span>
        </nav>
        ...
        <div className="grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(280px,340px)] xl:gap-8">
          <div className="min-w-0 space-y-6">
            ...
            <section
              aria-labelledby="lm05-outcomes-title"
            ...
            <LmLearningPath
              ...
              renderEmbed={(row, { lang: embedLang }) => {
                if (row.id === "lm05-interactive-chapter") {
                  return <Lm05ConceptPanel lang={embedLang} />;
                }
                return null;
              }}
            />
