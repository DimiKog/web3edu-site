...
const Lab05GR = () => {
    return (
        <LabTemplate
            ...
            subtitle="Κατανόησε πώς τα smart contracts αποθηκεύουν κατάσταση και πώς οι συναλλαγές τη μεταβάλλουν"
            conceptualFocusText={
                "Αυτό το εργαστήριο εισάγει τα smart contracts ως προγράμματα με κατάσταση που εκτελούνται στο blockchain. Θα παρατηρήσεις πώς η κατάσταση ενός συμβολαίου υπάρχει ανεξάρτητα από τα πορτοφόλια, πώς οι συναρτήσεις εκτελούνται μέσω συναλλαγών και πώς οι αλλαγές κατάστασης παραμένουν μετά την ένταξη σε block."
            }
            ...
            labels={{
                ...
                heroCaption:
                    "Η κατάσταση ενός smart contract ενημερώνεται μέσω συναλλαγών που περιλαμβάνονται σε blocks",
