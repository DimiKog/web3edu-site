...
const PoELab = () => {
    return (
        <ProjectLabTemplate
            ...
            subtitle="A gamified Web3 challenge that proves learning on-chain"
            heroImage={poeLogo}
...
There are no certificates here — only proof.
            `}
            whatYouDo={[
                "Explore the Proof of Escape challenge environment",
                "Interact with wallets, messages, and smart contracts",
                "Solve the required quizzes to unlock the final step",
                "Mint an on-chain proof of completion (NFT)",
            ]}
            unlocks={[
                "Proof of Escape on-chain NFT",
                "Eligibility for Web3Edu DAO access",
                "Verifiable project completion on your Web3 profile",
                "Access to future Applied & Project Labs",
            ]}
            primaryCta={{
                label: "Begin Proof of Escape →",
