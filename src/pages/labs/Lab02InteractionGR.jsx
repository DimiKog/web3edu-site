            ...
            <div className="max-w-5xl mx-auto px-4 py-12 space-y-10">
                ...
                <section>
                    ...
                    <p className="text-slate-600 dark:text-slate-300 max-w-3xl">
                        Κρυπτογράφησε ένα μήνυμα ώστε μόνο ο προοριζόμενος παραλήπτης να μπορεί να το διαβάσει —
                        χωρίς συναλλαγές, smart contracts ή αλληλεπίδραση με το blockchain.
                    </p>
                </section>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="rounded-xl border p-5">
                            ...
                            <p className="text-sm text-slate-700 dark:text-slate-400 mb-3">
                                Δώσε μια σύντομη είσοδο κειμένου για να παραχθεί ντετερμινιστικά ένα ζεύγος κλειδιών,
                        ...
                        <div className="rounded-xl border p-5">
                            ...
                            <p className="text-sm text-slate-600 dark:text-slate-400 mb-2">
                                Κρυπτογράφησε ένα μήνυμα χρησιμοποιώντας το δημόσιο κλειδί του παραλήπτη.
                            </p>
                        ...
                        <div className="rounded-xl border p-5">
                            ...
                            <p className="text-sm text-slate-600 dark:text-slate-400 mb-3">
                                Αποκρυπτογράφησε το κρυπτογραφημένο payload χρησιμοποιώντας το <strong>ιδιωτικό κλειδί</strong> του παραλήπτη.
                            </p>
                    ...
                    <section className="rounded-xl border border-indigo-200 dark:border-indigo-700 p-6 bg-indigo-50 dark:bg-indigo-900/30">
                        ...
                        <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300">
                            ...
                            <li>
                                ...
                                χωρίς smart contracts, gas ή αλληλεπίδραση με το δίκτυο.
                            </li>
                        </ul>
                    </section>
                )}
