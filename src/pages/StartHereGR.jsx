                        ...
                        <div className="rounded-xl p-6 border border-white/10 bg-white/[0.02]">
                            <ul className="space-y-3">
                                <li className="flex items-start gap-3">
                                    ...
                                    <span className="text-base text-white/70">Περίεργοι για το Web3 πέρα από το hype</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <svg className="w-5 h-5 text-[#4ACBFF] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <span className="text-base text-white/70">Πρόθυμοι να πειραματιστείτε και να «σπάσετε» πράγματα με ασφάλεια</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <svg className="w-5 h-5 text-[#4ACBFF] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <span className="text-base text-white/70">Ενδιαφέρεστε να κατανοήσετε πώς λειτουργούν πραγματικά τα πράγματα</span>
                                </li>
                            </ul>
                        </div>
                    ...
                    >
                        ...
                        <div className="grid md:grid-cols-3 gap-4 my-8">
                            <div className="rounded-xl p-6 border border-white/10 bg-white/[0.03]">
                                ...
                                <p className="text-sm text-white/70">Κάθε εργαστήριο εισάγει μία βασική έννοια Web3</p>
                            </div>
                            <div className="rounded-xl p-6 border border-white/10 bg-white/[0.03]">
                                ...
                                <p className="text-sm text-white/70">Κάθε εργαστήριο απαιτεί αλληλεπίδραση με πραγματικά εργαλεία</p>
                            </div>
                            <div className="rounded-xl p-6 border border-white/10 bg-white/[0.03]">
                                ...
                                <p className="text-sm text-white/70">Κάθε εργαστήριο αφήνει πίσω επαληθεύσιμη πρόοδο</p>
                            </div>
                        </div>
                        ...
                        <div className="rounded-2xl p-8 border border-white/10 bg-white/[0.02]">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div className="flex-1">
                                    <h3 className="text-lg font-semibold text-white mb-2">Βασικά Εργαστήρια</h3>
                    ...
                    >
                        <div className="rounded-2xl p-8 border border-white/10 bg-gradient-to-br from-[#8A57FF]/10 to-[#FF67D2]/10">
                            <div className="flex items-center gap-3 mb-4">
                                <span className="px-3 py-1 bg-[#8A57FF] text-white text-xs font-semibold rounded-full">Εφαρμοσμένο Εργαστήριο</span>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-4 my-6">
                                <div className="flex items-start gap-2">
                                    ...
                                    <span className="text-sm text-white/60">Δεν είναι εισαγωγή</span>
                                </div>
                                <div className="flex items-start gap-2">
                                    <svg className="w-5 h-5 text-red-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                    </svg>
                                    <span className="text-sm text-white/60">Δεν είναι tutorial</span>
                                </div>
                            </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="rounded-xl p-6 border border-white/10 bg-white/[0.02]">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <h3 className="font-semibold text-white">Τοπική Πρόοδος</h3>
                                </div>
                            ...
                            <div className="rounded-xl p-6 border border-white/10 bg-white/[0.02]">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <h3 className="font-semibold text-white">On-chain Απόδειξη</h3>
                                </div>
                                <p className="text-sm text-white/70">
                    ...
                    >
                        <div className="grid md:grid-cols-2 gap-4">
                            ...
                            <div className="flex items-center gap-3 rounded-lg p-4 border border-white/10 bg-white/[0.02]">
                                ...
                                <span className="text-base text-white/70">Διοχέτευση marketing</span>
                            </div>
                            <div className="flex items-center gap-3 rounded-lg p-4 border border-white/10 bg-white/[0.02]">
                                <svg className="w-5 h-5 text-red-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
