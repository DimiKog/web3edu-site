import{u as me,r as i,j as e,F as k,d as M,e as pe,f as O,h as he,i as fe}from"./react-vendor-B6F11S4b.js";import{P as be}from"./PageShell-DmAWanav.js";import{P as ge,I as we,D as x,X as ke,L as je}from"./PilotBanner-DxRq5Ox2.js";import{s as ve}from"./identity-ui-CjSEyPmB.js";import{u as ye}from"./web3-vendor-tXzdH6Yl.js";import"./ui-vendor-DM_ubCw2.js";import"./identity-icon-DIFp2Mb1.js";function Te(){const{address:u,isConnected:v}=ye(),c=me(),[t,X]=i.useState(null),[Ne,y]=i.useState(!1),[Be,N]=i.useState(null),[W,B]=i.useState(!1),[U,C]=i.useState(!1),b=i.useRef(null),g=i.useRef(null),[Ce,A]=i.useState(!1),[m,H]=i.useState(null),[F,J]=i.useState(null),[G,E]=i.useState(!1),[P,Y]=i.useState(localStorage.getItem("web3edu-builder-claimed")==="true"),[V,S]=i.useState(!1),K=i.useRef(null),Q={tier:"Explorer",xp:0,xpPercent:0,remainingXp:0,nextTierPercent:0,lessonsCompleted:0},Z=t&&typeof t=="object"&&!Array.isArray(t)?t:{},L={...Q,...Z},ee=(()=>{const r=L||{},a=m||{},o=[...Array.isArray(r.attributes)?r.attributes:[],...Array.isArray(a.attributes)?a.attributes:[]].some(p=>(p?.trait_type||"").toLowerCase()==="founder"&&(p?.value===!0||String(p?.value).toLowerCase()==="true"));return r.founder===!0||a.founder===!0||r.edition==="Founder Edition"||a.edition==="Founder Edition"||r.role==="Founder"||a.role==="Founder"||o})();i.useEffect(()=>{v||c("/join"),window.scrollTo(0,0)},[v,c]);const j=ve(u);i.useEffect(()=>{if(!u)return;const r="https://web3edu-api.dimikog.org";y(!0),N(null),fetch(`${r}/web3sbt/resolve/${u}`).then(a=>{if(!a.ok)throw new Error(`HTTP ${a.status}`);return a.json()}).then(a=>{const l=a?.metadata?.metadata&&typeof a.metadata.metadata=="object"?a.metadata.metadata:a?.metadata&&typeof a.metadata=="object"?a.metadata:{},o=a?.profile?.metadata&&typeof a.profile.metadata=="object"?a.profile.metadata:a?.profile&&typeof a.profile=="object"?a.profile:{};X({...l,tokenId:a?.tokenId});const p=d=>{if(typeof d=="string")try{return JSON.parse(d)}catch{return null}return d},z=d=>{const de=[d?.attributes,d?.attribute,d?.attrs,d?.traits,d?.traits_array,d?.traitsArray,d?.attributes_json,d?.attributesJson];for(const ce of de){const f=p(ce);if(Array.isArray(f))return f;if(f&&typeof f=="object")return Object.entries(f).map(([xe,ue])=>({trait_type:xe,value:ue}))}return[]},ae=z(l),se=z(o),h=[...ae,...se],q=o.role||l.role,$=o.specialization||o.speciality||l.specialization||l.speciality,le=h.some(d=>(d.trait_type||"").toLowerCase()==="role"),ie=h.some(d=>["specialization","speciality"].includes((d.trait_type||"").toLowerCase()));!le&&q&&h.push({trait_type:"Role",value:q}),!ie&&$&&h.push({trait_type:"Specialization",value:$});const ne=o.image&&o.image.trim()!==""?o.image:o.avatar&&o.avatar.trim()!==""?o.avatar:l.image&&l.image.trim()!==""?l.image:l.avatar&&l.avatar.trim()!==""?l.avatar:null,oe={...l,...o,name:o.name||l.name||j||"Web3Edu Identity",image:ne,attributes:h};H(oe),J(new Date)}).catch(a=>{console.error("Failed to fetch metadata:",a),N("Unable to load live progress — showing defaults.")}).finally(()=>y(!1))},[u,j]),i.useEffect(()=>{if(!t||typeof t.xp!="number")return;let r;return b.current==null||t.xp>b.current&&(C(!0),r=setTimeout(()=>C(!1),1200)),b.current=t.xp,()=>{r&&clearTimeout(r)}},[t]),i.useEffect(()=>{if(!t||typeof t.lessonsCompleted!="number")return;let r;return g.current==null||t.lessonsCompleted>g.current&&(A(!0),r=setTimeout(()=>A(!1),900)),g.current=t.lessonsCompleted,()=>r&&clearTimeout(r)},[t]),i.useEffect(()=>{if(!(!t||!t.tier))try{localStorage.setItem("web3edu-tier",t.tier)}catch(r){console.error("Failed to persist tier in localStorage:",r)}},[t?.tier]),i.useEffect(()=>{t?.tier&&(t.tier==="Builder"&&!P&&E(!0),K.current=t.tier)},[t?.tier,P]);const te={type:"guide",title:"Start Here — Your Web3 Learning Path",slug:"start-here",why:"This short guide explains how Web3Edu works and helps you choose what to learn next.",estimatedTime:5},w=t&&typeof t.recommendedNext=="object"?t.recommendedNext:null,R=w&&(w.title||w.slug),s=R?w:te,T=!R,_=!!s?.builderRequired;s?.builderStepIndex;const D=s?.slug?.endsWith("-gr")?s.slug.replace(/-gr$/,""):s?.slug,n=t?.builderChecklist||null,[I,re]=i.useState(t?.tier&&t.tier!=="Explorer");return e.jsx(be,{children:e.jsxs("div",{className:`
        ...
        `,children:[e.jsx("div",{className:"flex justify-center mb-3",children:e.jsxs("div",{className:"relative",children:[e.jsx("img",{src:m.image||"/icons/web3edu-identity.png",alt:"avatar",className:`
                    ...
                    `})]})}),e.jsxs("h2",{className:"text-3xl font-bold tracking-tight text-slate-900 dark:text-white flex items-center justify-center gap-3",children:["Welcome back, ",m.name||j," 👋",t?.tier&&e.jsx("span",{className:`
            ...
            `})]}),e.jsx(ge,{lang:document.documentElement.lang==="gr"?"gr":"en"}),G&&e.jsx("div",{className:"relative z-10 w-full max-w-4xl mx-auto mb-10 px-4",children:e.jsxs("div",{className:`
                        ...
                        `,children:[e.jsx("h2",{className:"text-2xl font-extrabold text-white mb-3",children:"🏗️ Builder Level Unlocked"}),e.jsxs("p",{className:"text-sm text-slate-200 mb-6",children:["You have completed the core requirements and unlocked",e.jsx("span",{className:"font-semibold text-purple-300",children:" Builder "}),"status. You are now eligible to participate in advanced governance tracks."]}),V?e.jsxs("div",{className:`
                                ...
                                backdrop-blur-xl shadow-xl text-slate-900 dark:text-slate-100
                                hover:scale-[1.005] hover:shadow-2xl transition-all duration-500
                            `,icon:e.jsx(M,{className:"w-5 h-5 text-white"}),children:e.jsx("p",{className:"text-sm font-mono text-slate-700 dark:text-slate-300 break-all",children:u??"—"})}),e.jsx(x,{title:"Rank",className:`
                            ...
                            `,icon:e.jsx(pe,{className:"w-5 h-5 text-white"}),children:e.jsxs("div",{className:"flex flex-col items-start gap-3 cursor-pointer",onClick:()=>B(!0),children:[e.jsxs("div",{className:`
...
`,children:"Start Here (guide)"})})]})]}),e.jsxs(x,{title:"Badges",className:`
                        ...
                        dark:border-white/10 backdrop-blur-xl shadow-xl text-slate-900 dark:text-slate-100
                        hover:scale-[1.005] hover:shadow-2xl transition-all duration-500
                    `,icon:e.jsx(k,{className:"w-5 h-5 text-white"}),children:[e.jsx("p",{className:"text-sm text-slate-700 dark:text-slate-200 mb-4 leading-relaxed",children:"All your achievements and earned badges will appear here as you progress."}),t&&t.badges?.length>0?e.jsx("div",{className:"flex flex-wrap gap-2",children:t.badges.map((r,a)=>{let l=k;const o=typeof r=="string"?r.toLowerCase():r?.label?.toLowerCase?.()||r?.en?.toLowerCase?.()||r?.gr?.toLowerCase?.()||"";return o.includes("wallet")&&(l=M),o.includes("lesson")&&(l=he),o.includes("quiz")&&(l=fe),e.jsxs("span",{className:`
                                                inline-flex items-center gap-2 
                                                px-3 py-1 rounded-full 
                                                ...
                                                text-slate-900 dark:text-slate-100
                                            `,children:[e.jsx(l,{className:"w-4 h-4 text-white/90"}),typeof r=="string"?r:r?.en||r?.gr||r?.label||JSON.stringify(r)]},`${a}-${typeof r=="string"?r:r?.id||"badge"}`)})}):e.jsx("p",{className:"text-slate-600 dark:text-slate-300",children:"No badges yet…"})]})]})]}),s&&e.jsx("div",{className:"relative z-10 w-full max-w-6xl mx-auto mt-6 mb-8 px-2 md:px-0",children:e.jsxs(x,{title:"Recommended Next Module",className:`
                rounded-2xl border border-indigo-300/30 dark:border-indigo-700/30
                bg-gradient-to-br from-white/95 via-indigo-50/75 to-slate-100/90
                dark:from-[#0E1426]/90 dark:via-[#0B1020]/85 dark:to-[#070C18]/90
                dark:border-white/10 backdrop-blur-xl shadow-xl
                hover:scale-[1.002] hover:shadow-2xl transition-all duration-500
            `,icon:e.jsx(O,{className:"w-5 h-5 text-white"}),children:[n&&e.jsxs("div",{className:`mb-4 rounded-xl border border-purple-300/30 dark:border-purple-700/40 
                                                bg-purple-50/70 dark:bg-purple-900/20 p-4`,children:[e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsx("span",{className:"text-xs font-semibold uppercase tracking-wide text-purple-700 dark:text-purple-300",children:"🏗 Builder Path"}),t?.tier==="Explorer"&&e.jsx("button",{onClick:r=>{r.stopPropagation(),re(a=>!a)},className:"text-xs font-semibold text-indigo-600 dark:text-indigo-400 hover:underline",children:I?"Hide details":"View requirements"}),t?.tier!=="Explorer"&&(n.coreLabs?.done&&n.daoLabs?.done&&n.proofOfEscape?.done&&n.xpRequirement?.done?e.jsx("span",{className:"text-green-600 dark:text-green-400 text-xs font-semibold",children:"✔ Builder Unlocked"}):e.jsx("span",{className:"text-xs text-slate-500 dark:text-slate-400",children:"In Progress"}))]}),I&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs",children:[e.jsxs("div",{children:[n.coreLabs?.done?"✔":"⏳"," Core Labs (",n.coreLabs?.completed,"/",n.coreLabs?.required,")"]}),e.jsxs("div",{children:[n.daoLabs?.done?"✔":"⏳"," DAO Labs (",n.daoLabs?.completed,"/",n.daoLabs?.required,")"]}),e.jsxs("div",{children:[n.proofOfEscape?.done?"✔":"⏳"," Proof of Escape"]}),e.jsxs("div",{children:[n.xpRequirement?.done?"✔":"⏳"," XP (",n.xpRequirement?.current,"/",n.xpRequirement?.required,")"]})]}),(()=>{const a=(n.coreLabs?.done?1:0)+(n.daoLabs?.done?1:0)+(n.proofOfEscape?.done?1:0),l=Math.round(a/3*100);return e.jsxs("div",{className:"mt-4",children:[e.jsxs("div",{className:"flex justify-between text-[10px] text-slate-500 dark:text-slate-400 mb-1",children:[e.jsx("span",{children:"Builder Progress"}),e.jsxs("span",{children:[a,"/",3," requirements"]})]}),e.jsx("div",{className:"w-full h-2 rounded-full bg-slate-200 dark:bg-slate-700 overflow-hidden",children:e.jsx("div",{className:"h-full bg-gradient-to-r from-purple-500 to-indigo-500 transition-all duration-500",style:{width:`${l}%`}})})]})})()]})]}),e.jsxs("div",{className:"space-y-3 cursor-pointer",onClick:()=>{if(s.type==="guide"&&s.slug){c(`/${s.slug}`);return}if(s.type==="lab"&&D){c(`/labs/${D}`);return}if(s.type==="lesson"&&s.slug){c(`/lessons/${s.slug}`);return}c("/education")},children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("p",{className:"text-xs uppercase tracking-wide text-indigo-600 dark:text-indigo-400 font-semibold",children:T?"Start Here":"Recommended for you"}),_&&e.jsx("span",{className:`
                                            inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold
                                            bg-purple-100/80 dark:bg-purple-900/40
                                            border border-purple-300/40 dark:border-purple-600/60
                                            text-purple-700 dark:text-purple-300
                                        `,children:"🏗 Builder Path"}),_&&e.jsx("span",{className:`
                                            text-[10px] font-medium text-slate-500 dark:text-slate-400
                                        `,children:"Final Builder Requirement"})]}),e.jsx("p",{className:"text-xl font-bold text-slate-900 dark:text-white leading-snug",children:typeof s.title=="object"?s.title.en||s.title.gr:s.title}),s.why&&e.jsxs("div",{className:"mt-1",children:[e.jsx("p",{className:"text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-500 mb-1",children:T?"Suggested next step":"Why this is recommended"}),e.jsx("p",{className:"text-sm text-slate-600 dark:text-slate-400 leading-relaxed max-w-3xl",children:typeof s.why=="object"?s.why.en||s.why.gr:s.why})]}),e.jsxs("div",{className:"flex flex-wrap items-center gap-6 pt-1 text-sm text-slate-600 dark:text-slate-400",children:[s.estimatedTime&&e.jsxs("span",{children:["⏱ ",s.estimatedTime," min"]}),s.xp&&e.jsxs("span",{children:["🏅 +",s.xp," XP"]})]}),e.jsx("div",{className:"pt-2",children:e.jsx("span",{className:"inline-flex items-center gap-1 text-sm font-semibold text-indigo-600 dark:text-indigo-400",children:"Continue →"})})]})]})}),e.jsx("div",{className:"relative z-10 w-full max-w-6xl mx-auto mt-12 px-2 md:px-0",children:e.jsx(je,{timeline:t?.timeline||[]})}),e.jsx("div",{className:`pointer-events-none fixed top-0 right-0 w-[300px] h-full
                                bg-gradient-to-b from-[#8A57FF]/35 via-[#4ACBFF]/25 to-[#FF67D2]/35
                                blur-[160px] opacity-60`}),W&&e.jsx("div",{className:"fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50",children:e.jsxs("div",{className:"bg-[#0f0f17] p-6 rounded-2xl w-80 border border-white/10 shadow-xl",children:[e.jsx("h2",{className:"text-xl font-bold mb-3 flex items-center gap-2",children:"Tier Benefits"}),e.jsxs("ul",{className:"text-white/80 text-sm space-y-2",children:[e.jsx("li",{children:"🟣 Explorer — Basic access, community role, progress tracking"}),e.jsx("li",{children:"🔵 Builder — Unlock advanced lessons, early DAO proposals"}),e.jsx("li",{children:"🟡 Architect — Full DAO access, beta features, priority badges"})]}),e.jsx("p",{className:"text-white/70 text-sm mt-4",children:"How to upgrade your tier:"}),e.jsxs("ul",{className:"text-white/80 text-sm space-y-1 mt-1",children:[e.jsx("li",{children:"• Complete lessons and quizzes to earn XP."}),e.jsx("li",{children:"• Return regularly and finish learning paths."}),e.jsx("li",{children:"• Participate in community / DAO activities (future)."})]}),e.jsx("button",{onClick:()=>B(!1),className:"mt-5 w-full py-2 rounded-xl bg-white/10 hover:bg-white/40 transition text-white font-semibold text-sm tracking-wide",children:"Close"})]})})]})})}export{Te as default};
