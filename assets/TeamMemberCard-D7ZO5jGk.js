import{j as e}from"./vendor-web3-CU4tlwXS.js";import"./vendor-react-BB8kI09H.js";import{F as g,b as F,c as w}from"./index-D7FA3d3P.js";function A({name:n,role:m,avatar:c,badges:o=[],socials:r={},bio:d="",quote:i="",mode:h="horizontal",className:p="",style:f={}}){const l=h==="horizontal",u={"*":"from-[#8A57FF]/40 via-[#4ACBFF]/40 to-[#FF67D2]/40 dark:from-[#8A57FF]/20 dark:via-[#4ACBFF]/20 dark:to-[#FF67D2]/20"},x={"*":"bg-[#8A57FF] text-[#8A57FF] dark:text-[#4ACBFF]"},b=u["*"];return e.jsxs("div",{className:`
...
`).map((a,t)=>t===0?e.jsx("p",{className:"font-bold text-lg md:text-xl leading-tight",children:a},t):e.jsx("p",{className:"text-sm md:text-base text-slate-600 dark:text-slate-400 leading-snug",children:a},t))})]}),e.jsxs("div",{className:`
                    ...
                    `,children:[e.jsx("h3",{className:`
                        ...
                        `,children:n}),o.length>0&&e.jsx("div",{className:`flex flex-wrap gap-2 mb-3 justify-center ${l?"md:justify-start":""}`,children:o.map((a,t)=>e.jsx("span",{className:"px-3 py-1.5 text-sm md:text-base font-semibold rounded-full bg-[#EDE8FF] text-[#8A57FF] dark:bg-[#1a1630] dark:text-[#C9B8FF] border border-[#8A57FF]/30",children:a},t))}),d&&e.jsx("div",{className:"text-base sm:text-lg md:text-xl text-slate-600 dark:text-slate-300 leading-relaxed w-full max-w-full md:max-w-[600px] space-y-3",children:d.split(`
