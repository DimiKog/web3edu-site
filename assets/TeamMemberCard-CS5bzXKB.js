import{j as e}from"./vendor-react-XZtyZRd7.js";import{F as g,b as F,c as w}from"./index-WtP7ZXML.js";function N({name:n,role:m,avatar:c,badges:d=[],socials:r={},bio:i="",quote:o="",mode:h="horizontal",className:p="",style:f={}}){const l=h==="horizontal",u={"*":"from-[#8A57FF]/40 via-[#4ACBFF]/40 to-[#FF67D2]/40 dark:from-[#8A57FF]/20 dark:via-[#4ACBFF]/20 dark:to-[#FF67D2]/20"},x={"*":"bg-[#8A57FF] text-[#8A57FF] dark:text-[#4ACBFF]"},b=u["*"];return e.jsxs("div",{className:`
            ...
            `,style:f,children:[e.jsxs("div",{className:`
               ...
               `,children:[e.jsxs("div",{className:`${l?"flex flex-col items-center w-full md:w-auto":"flex flex-col items-center w-full"}`,children:[e.jsx("img",{src:c,alt:n,className:`
                            ...
                            animate-avatarGlow
                        `,loading:"lazy"}),e.jsxs("div",{className:`flex gap-4 mt-3 justify-center ${l?"":"mb-2"}`,children:[e.jsx("a",{href:r.github||"#",target:"_blank",rel:"noopener noreferrer",className:`${r.github?"text-slate-700 hover:text-[#8A57FF] dark:text-slate-200 dark:hover:text-[#4ACBFF]":"opacity-30 cursor-not-allowed text-slate-500 dark:text-slate-600"} transition`,children:e.jsx(g,{size:22})}),e.jsx("a",{href:r.linkedin||"#",target:"_blank",rel:"noopener noreferrer",className:`${r.linkedin?"text-slate-700 hover:text-[#8A57FF] dark:text-slate-200 dark:hover:text-[#4ACBFF]":"opacity-30 cursor-not-allowed text-slate-500 dark:text-slate-600"} transition`,children:e.jsx(F,{size:22})}),e.jsx("a",{href:r.discord||"#",target:"_blank",rel:"noopener noreferrer",className:`${r.discord?"text-slate-700 hover:text-[#8A57FF] dark:text-slate-200 dark:hover:text-[#4ACBFF]":"opacity-30 cursor-not-allowed text-slate-500 dark:text-slate-600"} transition`,children:e.jsx(w,{size:22})})]}),e.jsx("div",{className:"mt-4 text-center text-slate-800 dark:text-slate-200 space-y-1",children:m.split(`
`).map((a,t)=>t===0?e.jsx("p",{className:"font-bold text-lg md:text-xl leading-tight",children:a},t):e.jsx("p",{className:"text-sm md:text-base text-slate-600 dark:text-slate-400 leading-snug",children:a},t))})]}),e.jsxs("div",{className:`
                    ...
                    `,children:[e.jsx("h3",{className:`
                        ...
                        `,children:n}),d.length>0&&e.jsx("div",{className:`flex flex-wrap gap-2 mb-3 justify-center ${l?"md:justify-start":""}`,children:d.map((a,t)=>e.jsx("span",{className:"px-3 py-1.5 text-sm md:text-base font-semibold rounded-full bg-[#EDE8FF] text-[#8A57FF] dark:bg-[#1a1630] dark:text-[#C9B8FF] border border-[#8A57FF]/30",children:a},t))}),i&&e.jsx("div",{className:"text-base sm:text-lg md:text-xl text-slate-600 dark:text-slate-300 leading-relaxed w-full max-w-full md:max-w-[600px] space-y-3",children:i.split(`
`).map((a,t)=>{const s=a.trim();return s.startsWith("—")||s.startsWith("-")||s.startsWith("•")||s.match(/^(\*\s+)/)?e.jsxs("div",{className:"flex items-start gap-3 text-left w-full",children:[e.jsx("div",{className:`
                                                ...
                                                `}),e.jsx("p",{className:`
                                                    ...
                                                    ${x["*"].replace(/^bg-[^\s]+ /,"")}
                                                `,children:s.replace(/^[-—•*]\s*/,"")})]},t):e.jsx("p",{className:"leading-relaxed",children:a},t)})}),o&&l&&e.jsxs("p",{className:"mt-4 italic text-lg text-slate-700 dark:text-slate-300 leading-relaxed border-l-4 border-[#8A57FF]/40 dark:border-[#8A57FF]/60 pl-4 max-w-[680px]",children:["“",o,"”"]})]})]}),e.jsx("div",{className:"w-full h-[4px] mt-4 rounded-full neon-separator"}),e.jsx("style",{children:`
