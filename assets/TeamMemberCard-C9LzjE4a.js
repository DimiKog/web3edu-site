import{j as e}from"./vendor-web3-D4o-zrKd.js";import"./vendor-react-BB8kI09H.js";import{F as g,b as F,c as w}from"./index-Dsk-GOBi.js";function A({name:d,role:m,avatar:c,badges:i=[],socials:r={},bio:n="",quote:x="",mode:h="horizontal",className:p="",style:f={}}){const l=h==="horizontal",u={"*":"from-[#8A57FF]/40 via-[#4ACBFF]/40 to-[#FF67D2]/40 dark:from-[#8A57FF]/20 dark:via-[#4ACBFF]/20 dark:to-[#FF67D2]/20"},o={"*":"bg-[#8A57FF] text-[#8A57FF] dark:text-[#4ACBFF]"},b=u["*"];return e.jsxs("div",{className:`
