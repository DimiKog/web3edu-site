import{d as E,r as x,j as e}from"./vendor-react-B7ncG0z2.js";import{P as D}from"./index-GPhR8bxb.js";import{s as C,g as w,A as v,E as f,B as b,a as j}from"./identity-ui-FJkvOzfu.js";function B(){const{address:s}=E(),[c,i]=x.useState(!0),[m,p]=x.useState(""),[n,N]=x.useState(null);x.useEffect(()=>{if(window.scrollTo(0,0),!s){p("Μη έγκυρη διεύθυνση."),i(!1);return}const F="https://web3edu-api.dimikog.org";i(!0),p(""),fetch(`${F}/web3sbt/verify/${s}`).then(r=>{if(!r.ok)throw new Error(`HTTP ${r.status}`);return r.json()}).then(r=>{N(r),i(!1)}).catch(r=>{console.error("Verify page error:",r),p("Αδυναμία φόρτωσης των δεδομένων SBT."),i(!1)})},[s]);const a=n?.metadata??{},l=n?.profile??{},k=(a.founder??l.founder)||!1,d=a.edition??l.edition??(k?"Founder Edition":null),t=a.tier??l.tier??"Explorer",u=a.xpPercent??0,y=a.lessonsCompleted??0,o=window.location.href,h=n?.tokenId??null,g=s?C(s):"";return e.jsx(D,{children:e.jsxs("div",{className:`
        min-h-screen 
