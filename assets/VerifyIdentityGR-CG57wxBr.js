import{k as D,u as C,r as x,j as e}from"./react-vendor-B6F11S4b.js";import{P as I}from"./PageShell-DmAWanav.js";import{s as S,g as v,A as N,E as f,B as b,a as j}from"./identity-ui-CjSEyPmB.js";import"./ui-vendor-DM_ubCw2.js";function _(){const{address:s}=D();C();const[c,i]=x.useState(!0),[m,p]=x.useState(""),[n,k]=x.useState(null);x.useEffect(()=>{if(window.scrollTo(0,0),!s){p("Μη έγκυρη διεύθυνση."),i(!1);return}const E="https://web3edu-api.dimikog.org";i(!0),p(""),fetch(`${E}/web3sbt/verify/${s}`).then(a=>{if(!a.ok)throw new Error(`HTTP ${a.status}`);return a.json()}).then(a=>{k(a),i(!1)}).catch(a=>{console.error("Verify page error:",a),p("Αδυναμία φόρτωσης των δεδομένων SBT."),i(!1)})},[s]);const r=n?.metadata??{},l=n?.profile??{},y=(r.founder??l.founder)||!1,d=r.edition??l.edition??(y?"Founder Edition":null),t=r.tier??l.tier??"Explorer",u=r.xpPercent??0;r.remainingXp;const F=r.lessonsCompleted??0,g=r.badges??[];Array.isArray(g)&&[...g];const o=window.location.href,h=n?.tokenId??null,w=s?S(s):"";return e.jsx(I,{children:e.jsxs("div",{className:`
        min-h-screen 
