import{j as e}from"./vendor-react-CTtygi22.js";import{F as g,a as F,b as w}from"./index-DTsofP66.js";function N({name:o,role:m,avatar:c,badges:d=[],socials:r={},bio:n="",quote:i="",mode:h="horizontal",className:p="",style:f={}}){const l=h==="horizontal",u={"*":"from-[#8A57FF]/40 via-[#4ACBFF]/40 to-[#FF67D2]/40 dark:from-[#8A57FF]/20 dark:via-[#4ACBFF]/20 dark:to-[#FF67D2]/20"},x={"*":"bg-[#8A57FF] text-[#8A57FF] dark:text-[#4ACBFF]"},b=u["*"];return e.jsxs("div",{className:`
