import{j as e}from"./vendor-react-CTtygi22.js";import{F as g,a as F,b as w}from"./index-CKAE6IlE.js";function N({name:o,role:m,avatar:c,badges:d=[],socials:r={},bio:n="",quote:i="",mode:h="horizontal",className:p="",style:f={}}){const l=h==="horizontal",u={"*":"from-[#8A57FF]/40 via-[#4ACBFF]/40 to-[#FF67D2]/40 dark:from-[#8A57FF]/20 dark:via-[#4ACBFF]/20 dark:to-[#FF67D2]/20"},x={"*":"bg-[#8A57FF] text-[#8A57FF] dark:text-[#4ACBFF]"},b=u["*"];return e.jsxs("div",{className:`
            ...
            `,style:f,children:[e.jsxs("div",{className:`
               ...
               `,children:[e.jsxs("div",{className:`${l?"flex flex-col items-center w-full md:w-auto":"flex flex-col items-center w-full"}`,children:[e.jsx("img",{src:c,alt:o,className:`
                            ...
                            animate-avatarGlow
                        `,loading:"lazy"}),e.jsxs("div",{className:`flex gap-3 mt-3 justify-center ${l?"":"mb-2"}`,children:[e.jsx("a",{href:r.github||"#",target:"_blank",rel:"noopener noreferrer",className:`${r.github?"text-slate-800 hover:text-[#8A57FF] dark:text-slate-200 dark:hover:text-[#4ACBFF] hover:bg-slate-900/5 dark:hover:bg-white/10":"opacity-30 cursor-not-allowed text-slate-500 dark:text-slate-600"} transition-colors rounded-full p-2`,children:e.jsx(g,{size:22})}),e.jsx("a",{href:r.linkedin||"#",target:"_blank",rel:"noopener noreferrer",className:`${r.linkedin?"text-slate-800 hover:text-[#8A57FF] dark:text-slate-200 dark:hover:text-[#4ACBFF] hover:bg-slate-900/5 dark:hover:bg-white/10":"opacity-30 cursor-not-allowed text-slate-500 dark:text-slate-600"} transition-colors rounded-full p-2`,children:e.jsx(F,{size:22})}),e.jsx("a",{href:r.discord||"#",target:"_blank",rel:"noopener noreferrer",className:`${r.discord?"text-slate-800 hover:text-[#8A57FF] dark:text-slate-200 dark:hover:text-[#4ACBFF] hover:bg-slate-900/5 dark:hover:bg-white/10":"opacity-30 cursor-not-allowed text-slate-500 dark:text-slate-600"} transition-colors rounded-full p-2`,children:e.jsx(w,{size:22})})]}),e.jsx("div",{className:"mt-4 text-center text-slate-800 dark:text-slate-200 space-y-1",children:m.split(`
...
`).map((a,t)=>{const s=a.trim();return s.startsWith("—")||s.startsWith("-")||s.startsWith("•")||s.match(/^(\*\s+)/)?e.jsxs("div",{className:"flex items-start gap-3 text-left w-full",children:[e.jsx("div",{className:`
                                                ...
                                                `}),e.jsx("p",{className:`
                                                    ...
                                                    ${x["*"].replace(/^bg-[^\s]+ /,"")}
                                                `,children:s.replace(/^[-—•*]\s*/,"")})]},t):e.jsx("p",{className:"leading-relaxed",children:a},t)})}),i&&l&&e.jsxs("p",{className:"mt-4 italic text-lg text-slate-700 dark:text-slate-300 leading-relaxed border-l-4 border-[#8A57FF]/40 dark:border-[#8A57FF]/60 pl-4 max-w-[680px]",children:["“",i,"”"]})]})]}),e.jsx("div",{className:"w-full h-[4px] mt-4 rounded-full neon-separator"}),e.jsx("style",{children:`
