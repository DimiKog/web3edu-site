import{j as e}from"./react-vendor-C3nCzrQE.js";import{F as g,a as F,b as w}from"./ui-vendor-CsLUdq9X.js";function N({name:d,role:m,avatar:c,badges:i=[],socials:r={},bio:n="",quote:x="",mode:h="horizontal",className:p="",style:f={}}){const l=h==="horizontal",u={"*":"from-[#8A57FF]/40 via-[#4ACBFF]/40 to-[#FF67D2]/40 dark:from-[#8A57FF]/20 dark:via-[#4ACBFF]/20 dark:to-[#FF67D2]/20"},o={"*":"bg-[#8A57FF] text-[#8A57FF] dark:text-[#4ACBFF]"},b=u["*"];return e.jsxs("div",{className:`
