import{j as e}from"./vendor-react-CTtygi22.js";import{_ as g,$ as w,a0 as F}from"./index-DroDvga3.js";function N({name:o,role:m,avatar:c,badges:d=[],socials:l={},bio:n="",quote:i="",mode:p="horizontal",className:h="",style:f={}}){const r=p==="horizontal",b={"*":"from-[#8A57FF]/40 via-[#4ACBFF]/40 to-[#FF67D2]/40 dark:from-[#8A57FF]/20 dark:via-[#4ACBFF]/20 dark:to-[#FF67D2]/20"},x={"*":"bg-[#8A57FF] text-[#8A57FF] dark:text-[#4ACBFF]"},u=b["*"];return e.jsxs("div",{className:`
