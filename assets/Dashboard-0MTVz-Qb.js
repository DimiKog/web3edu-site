import{u as me,r as i,j as e,F as k,d as M,e as pe,f as O,h as he,i as fe}from"./react-vendor-C3nCzrQE.js";import{s as be,P as ge}from"./index-DXlF0XQ8.js";import{P as we,I as ke,D as x,X as je,L as ve}from"./PilotBanner-ibjPR4nI.js";import{u as ye}from"./web3-vendor-DxqyInks.js";import"./ui-vendor-CsLUdq9X.js";import"./identity-icon-DIFp2Mb1.js";function Re(){const{address:u,isConnected:v}=ye(),c=me(),[t,X]=i.useState(null),[Ne,y]=i.useState(!1),[Be,N]=i.useState(null),[W,B]=i.useState(!1),[U,C]=i.useState(!1),b=i.useRef(null),g=i.useRef(null),[Ce,A]=i.useState(!1),[m,H]=i.useState(null),[F,J]=i.useState(null),[G,E]=i.useState(!1),[P,Y]=i.useState(localStorage.getItem("web3edu-builder-claimed")==="true"),[V,S]=i.useState(!1),K=i.useRef(null),Q={tier:"Explorer",xp:0,xpPercent:0,remainingXp:0,nextTierPercent:0,lessonsCompleted:0},Z=t&&typeof t=="object"&&!Array.isArray(t)?t:{},L={...Q,...Z},ee=(()=>{const r=L||{},a=m||{},o=[...Array.isArray(r.attributes)?r.attributes:[],...Array.isArray(a.attributes)?a.attributes:[]].some(p=>(p?.trait_type||"").toLowerCase()==="founder"&&(p?.value===!0||String(p?.value).toLowerCase()==="true"));return r.founder===!0||a.founder===!0||r.edition==="Founder Edition"||a.edition==="Founder Edition"||r.role==="Founder"||a.role==="Founder"||o})();i.useEffect(()=>{v||c("/join"),window.scrollTo(0,0)},[v,c]);const j=be(u);i.useEffect(()=>{if(!u)return;const r="https://web3edu-api.dimikog.org";y(!0),N(null),fetch(`${r}/web3sbt/resolve/${u}`).then(a=>{if(!a.ok)throw new Error(`HTTP ${a.status}`);return a.json()}).then(a=>{const l=a?.metadata?.metadata&&typeof a.metadata.metadata=="object"?a.metadata.metadata:a?.metadata&&typeof a.metadata=="object"?a.metadata:{},o=a?.profile?.metadata&&typeof a.profile.metadata=="object"?a.profile.metadata:a?.profile&&typeof a.profile=="object"?a.profile:{};X({...l,tokenId:a?.tokenId});const p=d=>{if(typeof d=="string")try{return JSON.parse(d)}catch{return null}return d},z=d=>{const de=[d?.attributes,d?.attribute,d?.attrs,d?.traits,d?.traits_array,d?.traitsArray,d?.attributes_json,d?.attributesJson];for(const ce of de){const f=p(ce);if(Array.isArray(f))return f;if(f&&typeof f=="object")return Object.entries(f).map(([xe,ue])=>({trait_type:xe,value:ue}))}return[]},ae=z(l),se=z(o),h=[...ae,...se],q=o.role||l.role,$=o.specialization||o.speciality||l.specialization||l.speciality,le=h.some(d=>(d.trait_type||"").toLowerCase()==="role"),ie=h.some(d=>["specialization","speciality"].includes((d.trait_type||"").toLowerCase()));!le&&q&&h.push({trait_type:"Role",value:q}),!ie&&$&&h.push({trait_type:"Specialization",value:$});const ne=o.image&&o.image.trim()!==""?o.image:o.avatar&&o.avatar.trim()!==""?o.avatar:l.image&&l.image.trim()!==""?l.image:l.avatar&&l.avatar.trim()!==""?l.avatar:null,oe={...l,...o,name:o.name||l.name||j||"Web3Edu Identity",image:ne,attributes:h};H(oe),J(new Date)}).catch(a=>{console.error("Failed to fetch metadata:",a),N("Unable to load live progress — showing defaults.")}).finally(()=>y(!1))},[u,j]),i.useEffect(()=>{if(!t||typeof t.xp!="number")return;let r;return b.current==null||t.xp>b.current&&(C(!0),r=setTimeout(()=>C(!1),1200)),b.current=t.xp,()=>{r&&clearTimeout(r)}},[t]),i.useEffect(()=>{if(!t||typeof t.lessonsCompleted!="number")return;let r;return g.current==null||t.lessonsCompleted>g.current&&(A(!0),r=setTimeout(()=>A(!1),900)),g.current=t.lessonsCompleted,()=>r&&clearTimeout(r)},[t]),i.useEffect(()=>{if(!(!t||!t.tier))try{localStorage.setItem("web3edu-tier",t.tier)}catch(r){console.error("Failed to persist tier in localStorage:",r)}},[t?.tier]),i.useEffect(()=>{t?.tier&&(t.tier==="Builder"&&!P&&E(!0),K.current=t.tier)},[t?.tier,P]);const te={type:"guide",title:"Start Here — Your Web3 Learning Path",slug:"start-here",why:"This short guide explains how Web3Edu works and helps you choose what to learn next.",estimatedTime:5},w=t&&typeof t.recommendedNext=="object"?t.recommendedNext:null,R=w&&(w.title||w.slug),s=R?w:te,T=!R,_=!!s?.builderRequired;s?.builderStepIndex;const D=s?.slug?.endsWith("-gr")?s.slug.replace(/-gr$/,""):s?.slug,n=t?.builderChecklist||null,[I,re]=i.useState(t?.tier&&t.tier!=="Explorer");return e.jsx(ge,{children:e.jsxs("div",{className:`
        ...
        `,children:[e.jsx("div",{className:"flex justify-center mb-3",children:e.jsxs("div",{className:"relative",children:[e.jsx("img",{src:m.image||"/icons/web3edu-identity.png",alt:"avatar",className:`
            ...
            `})]}),e.jsx(we,{lang:document.documentElement.lang==="gr"?"gr":"en"}),G&&e.jsx("div",{className:"relative z-10 w-full max-w-4xl mx-auto mb-10 px-4",children:e.jsxs("div",{className:`
                        ...
                        `,children:[e.jsx("h2",{className:"text-2xl font-extrabold text-white mb-3",children:"🏗️ Builder Level Unlocked"}),e.jsxs("p",{className:"text-sm text-slate-200 mb-6",children:["You have completed the core requirements and unlocked",e.jsx("span",{className:"font-semibold text-purple-300",children:" Builder "}),"status. You are now eligible to participate in advanced governance tracks."]}),V?e.jsxs("div",{className:`
                            ...
                            hover:scale-[1.005] hover:shadow-2xl transition-all duration-500
                        `,icon:e.jsx(k,{className:"w-5 h-5 text-white"}),children:e.jsx(je,{xp:t?.xp??0,xpPercent:t?.xpPercent??0,remainingXp:t?.remainingXp??0,nextTierPercent:t?.nextTierPercent??0,tier:t?.tier??"Explorer",xpLeveledUp:U})}),e.jsxs(x,{title:"Quick Actions",className:`
                            rounded-2xl border border-indigo-300/30 dark:border-indigo-700/30
                            bg-gradient-to-br from-white/95 via-indigo-50/75 to-slate-100/90
                            dark:from-[#0E1426]/90 dark:via-[#0B1020]/85 dark:to-[#070C18]/90
                            dark:border-white/10 backdrop-blur-xl shadow-xl text-slate-900 dark:text-slate-100
